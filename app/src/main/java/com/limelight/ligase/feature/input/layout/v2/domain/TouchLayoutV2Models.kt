...
data class TouchLayoutV2Document(
    val layoutId: String,
    val revision: Long,
    val displayName: String,
    val extensions: Map<String, StrictJsonValue>,
    val variants: List<TouchLayoutV2Variant>,
    val contentHash: String,
)

data class TouchLayoutV2Variant(
    val variantId: String,
    val deviceClasses: List<DeviceClass>,
    val orientations: List<LayoutOrientation>,
    val recommendation: LayoutRecommendation,
    val canvas: IntSize,
    val elements: List<TouchLayoutV2Element>,
)

enum class DeviceClass { PHONE, TABLET }
enum class LayoutOrientation { PORTRAIT, LANDSCAPE }
enum class SafeAreaPolicy { VIDEO_CONTENT, VIDEO_CONTENT_AND_SYSTEM_INSETS }
...
data class TouchLayoutV2Element(
...
data class ViewportInput(
    val videoContent: IntRect,
    val systemSafeArea: IntRect?,
)
